...
<div align="center">
   <a href="https://www.qgis.org/it/site/"><img src="./imgs/splash344_ltr.png" width="400" title="QGIS 3.44 LTR Solothurn"></a>
</div>
...
```mermaid
gantt
    title Calendario del Corso QGIS
    dateFormat YYYY-MM-DD
    axisFormat Giorno %d

    section Modulo Base
    Giorno 1 - Introduzione e Fondamenti    :crit, base, 2026-01-01, 1d

    section Modulo Avanzato
    Giorno 2 - Strumenti Avanzati (Parte 1)  :active, avanzato1, 2026-01-02, 1d
    Giorno 3 - Strumenti Avanzati (Parte 2)  :active, avanzato2, 2026-01-03, 1d
```
